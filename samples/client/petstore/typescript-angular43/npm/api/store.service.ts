...
export class StoreService {
    ...
    public deleteOrder(orderId: string, ): Observable<{}> {
        ...
        return this.httpClient.delete(`${this.basePath}/store/order/${orderId}`, {
            headers: headers,
    ...
    public getOrderById(orderId: number, ): Observable<Order> {
        ...
        return this.httpClient.get(`${this.basePath}/store/order/${orderId}`, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public placeOrder(body: Order, ): Observable<Order> {
        ...
        return this.httpClient.post(`${this.basePath}/store/order`, body, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
