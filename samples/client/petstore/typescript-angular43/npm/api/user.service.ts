...
export class UserService {
    ...
    public createUsersWithArrayInput(body: Array<User>, ): Observable<{}> {
        ...
        return this.httpClient.post(`${this.basePath}/user/createWithArray`, body, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public createUsersWithListInput(body: Array<User>, ): Observable<{}> {
        ...
        return this.httpClient.post(`${this.basePath}/user/createWithList`, body, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public deleteUser(username: string, ): Observable<{}> {
        ...
        return this.httpClient.delete(`${this.basePath}/user/${username}`, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public getUserByName(username: string, ): Observable<User> {
        ...
        return this.httpClient.get(`${this.basePath}/user/${username}`, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public updateUser(username: string, body: User, ): Observable<{}> {
        ...
        return this.httpClient.put(`${this.basePath}/user/${username}`, body, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
