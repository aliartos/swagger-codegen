...
export class PetService {
    ...
    public addPet(body: Pet, ): Observable<{}> {
        ...
        return this.httpClient.post(`${this.basePath}/pet`, body, {
            headers: headers,
    ...
    public deletePet(petId: number, apiKey?: string, ): Observable<{}> {
        ...
        return this.httpClient.delete(`${this.basePath}/pet/${petId}`, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public getPetById(petId: number, ): Observable<Pet> {
        ...
        return this.httpClient.get(`${this.basePath}/pet/${petId}`, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public updatePet(body: Pet, ): Observable<{}> {
        ...
        return this.httpClient.put(`${this.basePath}/pet`, body, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public updatePetWithForm(petId: number, name?: string, status?: string, ): Observable<{}> {
        ...
        return this.httpClient.post(`${this.basePath}/pet/${petId}`, formParams, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
    ...
    public uploadFile(petId: number, additionalMetadata?: string, file?: Blob, ): Observable<ApiResponse> {
        ...
        return this.httpClient.post(`${this.basePath}/pet/${petId}/uploadImage`, formParams, {
            headers: headers,
            withCredentials: this.configuration.withCredentials,
        });
    }
